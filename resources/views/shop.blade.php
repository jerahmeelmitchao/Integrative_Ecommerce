                    ...
                    <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0 pt-3 category-list">
                            <ul class="list list-inline mb-0">
                                ...
                                {{-- <a href="{{route('shop.index')}}" class="menu-link py-1">All</a> --}}
                    ...
                    <div id="accordion-filter-2" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                <a href="#" class="swatch-color js-filter" style="border-color: black; color: #fff; border: 1px solid black;"></a>
                                <a href="#" class="swatch-color js-filter" style="border-color: red; color: #ff0000; border: 1px solid red;"></a>
                                <a href="#" class="swatch-color js-filter" style="border-color: #282828; color: #282828; border: 1px solid #282828;"></a>
                                <a href="#" class="swatch-color js-filter" style="border-color: #8B0000; color: #8B0000; border: 1px solid #8B0000;"></a>
                ...
                <div class="accordion-item mb-4">
                    ...
                    <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                        ...
                        <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="10"
                            data-slider-max="2000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="₱" />
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            <div class="slide-split_text position-relative d-flex align-items-center"
                                ...
                                <div class="slideshow-text container p-3 p-xl-5">
                                    <h2 class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2"> Rice <br /><strong>VARIETIES</strong></h2>
                                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Rice is a staple that elevates every meal.
                                        Enjoy the wholesome taste of high-quality grains, perfect for creating comforting dishes or family favorites.
                                        From fragrant varieties to everyday essentials, our rice brings flavor and satisfaction to every table.</h6>
                                </div>
                            </div>
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="{{ asset('assets/images/classb.jpg') }}" width="630" height="450" alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            ...
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="{{ asset('assets/images/classc.jpg') }}" width="630" height="450" alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                            ...
                            <div class="slide-split_media position-relative">
                                <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                    <img loading="lazy" src="{{ asset('assets/images/class-a.jpg') }}" width="630" height="450" alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-between mb-4 pb-md-2">
                ...
                <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                    ...
                    <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items" name="orderby" id="orderby">
                        ...
                        <option value="5" {{ $order == 5 ? 'selected' : '' }}>Name, A-Z</option>
                        <option value="6" {{ $order == 6 ? 'selected' : '' }}>Name, Z-A</option>
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                        <div class="pc__img-wrapper">
                            <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}"><img loading="lazy" src="{{ asset('uploads/products/' . $product->image) }}" width="330" height="400" alt="{{ $product->name }}" class="pc__img">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
...
<script>
    $(function() {
        ...
        $("input[name='brands']").on("change", function() { // Corrected selector here
            var brands = "";
        ...
        $("input[name='categories']").on("change", function() { // Corrected selector here
            var categories = "";
        ...
        $(".price-range-slider").on("slide", function(event) {
            $(".price-range__min").text("₱" + event.value[0]);
            $(".price-range__max").text("₱" + event.value[1]);
        });
