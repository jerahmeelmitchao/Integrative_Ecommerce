...
<head>
    ...
    <meta name="author" content="Mitchao" />
...
<body class="body">
                ...
                <div class="section-content-right">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                <span class="image">
                                                    <img src="{{ asset('images/ml.jng') }}" alt="">
                                                </span>
                                                <span class="flex flex-column">
                                                    <span class="body-title mb-2">Jerahmeel Mitchao</span>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <form method="POST" action="{{route('logout')}}" id="logout-form">
                                                    @csrf
                                                    <a class="user-item" href="{{route('logout')}}" class="" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                                        <div class="icon"><i class="icon-log-out"></i></div>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Mitchao,Jerahmeel</div>
                        </div>
                    </div>
    ...
    <!-- Include Bootstrap JS (make sure it's after jQuery) -->
