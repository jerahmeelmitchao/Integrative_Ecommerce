                ...
                <div class="w-half">
                    ...
                    <div class="wg-chart-default mb-20">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                <div class="image ic-bg">
                                    <span style="font-size: 24px; color:#007FFF;">₱</span>
                                </div>
                                <div>
    ...
    (function($) {
        ...
        var tfLineChart = (function() {
            ...
            var chartBar = function() {
                if (document.getElementById('line-chart-8')) { // Check to avoid duplicate rendering
                    var options = {
                        series: [
                            { name: 'Total', data: [{{$AmountM}}] },
                            { name: 'Pending', data: [{{$OrderedAmountM}}] },
                            { name: 'Delivered', data: [{{$DeliveredAmountM}}] },
                            { name: 'Canceled', data: [{{$CanceledAmountM}}] }
                        ],
                    ...
                    new ApexCharts(document.querySelector('#line-chart-8'), options).render();
                }
            };
